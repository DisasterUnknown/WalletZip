...
class CustomColors {
  ...
  static Future<void> _loadThemes() async {
    ...
    try {
      // === Default ===
      final defaultJson =
          await rootBundle.loadString('lib/core/theme/default.json');

      // === Dark themes ===
      final darkGrayJson =
          await rootBundle.loadString('lib/core/theme/dark/darkGrayTheme.json');
      final deepPurpleJson = await rootBundle
          .loadString('lib/core/theme/dark/deepPurpleTheme.json');
      final forestGreenJson = await rootBundle
          .loadString('lib/core/theme/dark/forestGreenTheme.json');
      final oceanBlueJson = await rootBundle
          .loadString('lib/core/theme/dark/oceanBlueTheme.json');

      // === Light themes ===
      final skyLightJson =
          await rootBundle.loadString('lib/core/theme/light/skyLightTheme.json');
      final aquaLightJson =
          await rootBundle.loadString('lib/core/theme/light/aquaLightTheme.json');
      final blushPinkJson = await rootBundle
          .loadString('lib/core/theme/light/blushPinkTheme.json');
      final classicLightJson = await rootBundle
          .loadString('lib/core/theme/light/classicLightTheme.json');
      final mintGreenJson = await rootBundle
          .loadString('lib/core/theme/light/mintGreenTheme.json');
      final sunnyYellowJson = await rootBundle
          .loadString('lib/core/theme/light/sunnyYellowTheme.json');
  ...
  static Color getColorSync(String colorName,
